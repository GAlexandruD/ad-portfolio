  ...
  return (
    <div className="relative mx-auto flex h-screen max-w-7xl flex-col items-center space-y-10 px-2 text-center sm:px-10">
      ...
      <div className="flex flex-1 flex-col items-center justify-center md:flex-row md:text-left">
        <motion.img
          className="h-36 w-36 rounded-full object-cover brightness-90  hover:grayscale-[40%] dark:grayscale dark:hover:brightness-75 sm:h-56 sm:w-56 md:h-96 md:w-64 md:rounded-lg xl:h-[500px] xl:w-[400px]"
          initial={{
            x: -200,
            opacity: 0,
          }}
